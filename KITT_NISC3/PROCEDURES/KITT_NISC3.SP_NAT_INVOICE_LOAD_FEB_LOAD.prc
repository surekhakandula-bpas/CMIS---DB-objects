DROP PROCEDURE "SP_NAT_INVOICE_LOAD_feb_load";

CREATE OR REPLACE PROCEDURE            "SP_NAT_INVOICE_LOAD_feb_load" (InvoiceID number) AS 
 NewInvoiceID number;
                           ...
                           when '3273094724' then '327309472400'
                            when '3273094725' then '327309472500'
                             when '3273128072' then '327312807200'
                              ...
                              when '3428799052' then  '342879905200'
                              when '3428673306' then '342867330600'
                              when '3420045695' then '342004569500'
                           else A.EXTERNAL_ID
                           end
                          ,0
                          ,'n/a'
...
END SP_NAT_INVOICE_LOAD_feb_load;
/
