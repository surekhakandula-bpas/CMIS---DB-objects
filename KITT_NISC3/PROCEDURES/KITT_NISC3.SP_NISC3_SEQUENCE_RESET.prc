DROP PROCEDURE SP_NISC3_SEQUENCE_RESET;

CREATE OR REPLACE PROCEDURE            SP_NISC3_SEQUENCE_RESET(
                        p_PStatus          OUT VARCHAR2 )  
/*
---------------------------------------------------------------------------------------------------
  Object Name:  SP_NISC3_SEQUENCE_REFRESH
  Author:       J Feld
...
GRANT EXECUTE ON SP_NISC3_SEQUENCE_RESET TO SNAMBIAR;
